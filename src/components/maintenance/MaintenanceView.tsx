                    ...
                    >
                      ...
                      <td className="p-3.5">
                        <div className="flex flex-col">
                          <span className="font-mono font-bold text-slate-900 group-hover:text-amber-800">
                            <HighlightedText text={req.requestNumber} searchQuery={searchTerm} />
                          </span>
                      ...
                      <td className="p-3.5">
                        <div className="flex flex-col">
                          <span className="font-bold text-slate-900">
                            <HighlightedText text={prop?.nameAr || prop?.nameEn || "—"} searchQuery={searchTerm} />
                          </span>
                          <span className="text-[11px] text-slate-600 font-semibold mt-0.5">
                            {language === "ar" ? "وحدة: " : "Unit: "}
                            <HighlightedText text={u?.unitNumber || "—"} searchQuery={searchTerm} />
                          </span>
                          {tnt && (
                            <span className="text-[10px] text-slate-400 truncate max-w-[140px]">
                              <HighlightedText text={tnt.nameAr || tnt.nameEn} searchQuery={searchTerm} />
                            </span>
                          )}
                        </div>
                      </td>
                      ...
                      <td className="p-3.5">
                        <span className="px-2.5 py-1 rounded-lg bg-slate-100 text-slate-800 font-semibold text-[11px]">
                          <HighlightedText text={req.category} searchQuery={searchTerm} />
                        </span>
                      </td>
