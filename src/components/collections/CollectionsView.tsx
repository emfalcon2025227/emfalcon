      ...
      {activeTab === "HISTORY" && (
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {filteredHistoryGroups.map((group, groupIndex) => {
                      ...
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2">
                          <span className="font-mono font-black text-sm text-slate-900 flex items-center gap-1.5">
                            ...
                            <span>
                              {language === "ar" ? "شيك رقم: " : "Cheque # "}
                              <HighlightedText text={group.chequeNumber} searchQuery={searchTerm} />
                            </span>
                          </span>

                          <span className="text-xs text-slate-500 font-medium px-2 py-0.5 bg-slate-100 rounded-md">
                            <HighlightedText text={group.bankName} searchQuery={searchTerm} />
                          </span>
                        ...
                        <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-1 text-xs text-slate-500">
                          <span className="font-bold text-slate-800 flex items-center gap-1">
                            ...
                            {tenant?.phone && (
                              <span className="font-mono text-slate-400 text-[11px]">
                                (<HighlightedText text={tenant.phone} searchQuery={searchTerm} />)
                              </span>
                            )}
                          </span>
                          ...
                          <span className="flex items-center gap-1">
                            ...
                            <span>
                              {prop ? (
                                <HighlightedText text={language === "ar" ? prop.nameAr : prop.nameEn} searchQuery={searchTerm} />
                              ) : (
                                ""
                              )}
                            </span>
                            {unit && (
                              <span className="text-slate-400">
                                ...
                                <HighlightedText text={unit.unitNumber} searchQuery={searchTerm} />
                              </span>
                            )}
                          </span>
                                ...
                                <div className="space-y-1">
                                  <div className="flex flex-wrap items-center gap-2">
                                    <span className="font-mono font-black text-xs text-slate-900 flex items-center gap-1">
                                      ...
                                      <span>
                                        <HighlightedText text={rcp.receiptNumber} searchQuery={searchTerm} />
                                      </span>
                                    </span>
                                  ...
                                  <div className="flex flex-wrap items-center gap-x-3 text-xs text-slate-600 pt-0.5">
                                    <span>
                                      ...
                                      <strong className="text-slate-900">
                                        <HighlightedText text={rcp.payerName} searchQuery={searchTerm} />
                                      </strong>
                                    </span>
                                    {rcp.collectedBy && (
