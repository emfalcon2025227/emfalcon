                  ...
                  >
                    ...
                    <td className="py-3 px-4 font-bold text-slate-900">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-mono font-black text-slate-900">
                          #<HighlightedText text={cheque.chequeNumber} searchQuery={searchTerm} />
                        </span>
                      </div>
                      <div className="text-[10px] text-slate-500 font-medium">
                        <HighlightedText text={cheque.bankName} searchQuery={searchTerm} />
                      </div>
                    </td>
                    ...
                    <td className="py-3 px-4">
                      <div className="font-semibold text-slate-900 line-clamp-1">
                        <HighlightedText text={owners.find(o => o.id === cheque.ownerId)?.[language === "ar" ? "nameAr" : "nameEn"] || cheque.ownerName || "Owner"} searchQuery={searchTerm} />
                      </div>
                      <div className="text-[11px] text-slate-500 line-clamp-1">
                        <HighlightedText text={prop ? (language === "ar" ? prop.nameAr : prop.nameEn) : "Property"} searchQuery={searchTerm} /> • Unit #<HighlightedText text={unit?.unitNumber} searchQuery={searchTerm} />
                      </div>
                    </td>
