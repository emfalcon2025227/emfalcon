...
export const LoginView: React.FC = () => {
  ...
  React.useEffect(() => {
    // Auto prefill username from URL if present (useful for activation / reset fallback links)
    if (typeof window !== "undefined") {
      ...
      <main className="flex-1 flex items-center justify-center p-4 z-10 my-4">
        <div className="w-full max-w-md bg-white rounded-3xl p-8 sm:p-10 shadow-2xl text-slate-800 border border-slate-100 animate-in fade-in zoom-in-95 duration-200">
          ...
          {(() => {
            ...
            return (displayError === "auth/operation-not-allowed" || displayError.includes("auth/operation-not-allowed")) ? (
              <div className="mb-6 p-5 rounded-2xl bg-amber-50/70 border border-amber-200 text-slate-800 text-xs shadow-xs animate-in fade-in duration-200">
                ...
                <div className="bg-white/80 rounded-xl p-4 border border-amber-200/50 space-y-3 mb-4">
                  ...
                  <ol className="list-decimal list-inside space-y-2 text-slate-600 text-[11px] leading-relaxed">
                    <li>
                      ...
                      <a 
                        href="https://console.firebase.google.com/project/emirates-falcon-erp/authentication/providers" 
                        target="_blank" 
                ...
                <div className="flex items-center justify-between gap-2.5">
                  <span className="text-[10px] text-slate-400 font-mono">ID: emirates-falcon-erp</span>
                  <button
                    type="button"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={loginMode === "OWNER" ? (language === "ar" ? "اسم مستخدم المالك" : "Owner username") : (loginMode === "TENANT" ? (language === "ar" ? "اسم مستخدم المستأجر" : "Tenant username") : (language === "ar" ? "اسم المستخدم (مثال: Mahmoud)" : "Username (e.g. Mahmoud)"))}
