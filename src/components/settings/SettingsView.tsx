  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-2 rounded-2xl border border-slate-200/80 shadow-2xs flex flex-wrap gap-2">
        ...
        {(currentUser?.role === "SYSTEM_OWNER" || currentUser?.role === "SUPER_ADMIN") && (
          <button
      ...
      {activeTab === "FIREBASE" && (currentUser?.role === "SYSTEM_OWNER" || currentUser?.role === "SUPER_ADMIN") && <FirebaseConnectionTester />}
