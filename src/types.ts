...
export interface LeaseModificationRequest {
  id: string;
  leaseId: string;
  leaseNumber: string;
  requestedAt: string;
  ...
  proposedAnnualRent?: number;
  proposedInstallments?: LeaseInstallment[];
  proposedSecurityDeposit?: number;
  proposedStartDate?: string;
  proposedEndDate?: string;
  proposedPatch: Partial<Lease>;
...
export interface Lease {
  ...
  contractStatus: LeaseContractStatus;
  renewalDate?: string;
  ejariNumber?: string;
