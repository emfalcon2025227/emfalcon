              ...
              {filteredTenants.map((tenant) => (
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-[10px] text-slate-400 font-mono">
                          <HighlightedText text={tenant.code} searchQuery={searchTerm} />
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="py-3 px-4">
                    ...
                    <div className="text-[10px] text-slate-400 font-mono">
                      <HighlightedText text={tenant.emiratesId || tenant.tradeLicenseNo || tenant.passportNumber || "N/A"} searchQuery={searchTerm} />
                    </div>
                  </td>
                  ...
                  <td className="py-3 px-4">
                    ...
                    <div className="text-[10px] text-slate-400 truncate max-w-[140px]">
                      <HighlightedText text={tenant.email} searchQuery={searchTerm} />
                    </div>
                  </td>
