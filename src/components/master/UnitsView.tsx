                  ...
                  <tr key={unit.id} className="hover:bg-slate-50/70 transition-colors">
                    <td className="py-3 px-4 font-bold text-slate-900">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] text-slate-400 font-normal">
                          F<HighlightedText text={unit.floor} searchQuery={searchTerm} />
                        </span>
                      </div>
                    </td>
                    ...
                    <td className="py-3 px-4">
                      <div className="font-semibold text-slate-900">
                        <HighlightedText text={prop ? (language === "ar" ? prop.nameAr : prop.nameEn) : "N/A"} searchQuery={searchTerm} />
                      </div>
                        ...
                        <div>
                          ...
                          {unit.currentLeaseId && (
                            <div className="text-[10px] font-mono text-slate-400 mt-0.5">
                              <HighlightedText text={leases.find((l) => l.id === unit.currentLeaseId)?.leaseNumber} searchQuery={searchTerm} />
                            </div>
                          )}
                        </div>
                      ) : (
